...
public class FragmentPlayerLottery extends BaseFragment {
    private Video mVideo;
    private double mPXTimes;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRoot = (ViewGroup) inflater.inflate(R.layout.fragment_player_lottery, container, false);
    ...
    private void initView() {
        ...
        mPXTimes = (mRoot.findViewById(R.id.lottery_layout)).getLayoutParams().height / 100;
...
//        mLayoutParams.setMargins(980, 0, 0, 0);
...
//				.displayImageDefault(mVideo.lottery.prize_list.get(2).image, cLevelImg);
        getSystem(SystemCommon.class).displayDefaultImage(FragmentPlayerLottery.this, aLevelImg, mVideo.lottery.prize_list.get(0).image);
        getSystem(SystemCommon.class).displayDefaultImage(FragmentPlayerLottery.this, bLevelImg, mVideo.lottery.prize_list.get(1).image);
        getSystem(SystemCommon.class).displayDefaultImage(FragmentPlayerLottery.this, cLevelImg, mVideo.lottery.prize_list.get(2).image);
        // 奖品名字
