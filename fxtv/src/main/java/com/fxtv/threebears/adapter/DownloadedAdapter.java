...
/**
 * 下载完成s列表的XListVIew的适配器
 *
 * @author 薛建浩
 */
public class DownloadedAdapter extends BaseListGridAdapter<Video> {

    private Context context;

    /**
     * 改变状态用于切换下载中和完成下载两个lisiView的显示方式 true--切换成完成下载的样式 false--切换成正在下载的样式
     */
    ...
    public DownloadedAdapter(Context context, List<Video> list) {
        super(list);
        this.context = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView.findViewById(R.id.pause_start_download).setVisibility(View.GONE);
