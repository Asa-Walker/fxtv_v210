...
package com.fxtv.threebears.view.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.fxtv.threebears.R;
import com.fxtv.threebears.view.wheelview.adapters.WheelViewAdapter;
...
public class MyWheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.color_white;
	private int wheelForeground = R.drawable.wheel_date;
