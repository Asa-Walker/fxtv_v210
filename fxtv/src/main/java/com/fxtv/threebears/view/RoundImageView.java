...
public class RoundImageView extends ImageView {
	...
	private int defaultColor = 0xFFFFFF00;
	// 如果只有其中一个有值，则只画一个圆形边框
	private int mBorderOutsideColor = getResources().getColor(R.color.color_white);
	private int mBorderInsideColor = getResources().getColor(R.color.color_white);
	// 控件默认长、宽
