...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private void initVideoView(Context context) {
        ...
        mVideoWidth = 0;
        mVideoHeight = 0;
        mScreenHeight = SystemManager.getInstance().getSystem(SystemCommon.class).mScreenHeight;
        mScreenWidth = SystemManager.getInstance().getSystem(SystemCommon.class).mScreenWidth;
        setFocusable(true);
    ...
    public void setAspectRatio(boolean isLandscape, int aspectRatio) {
        if (mVideoHeight > 0 && mVideoWidth > 0) {
            ...
            switch (aspectRatio) {
                case IRenderView.AR_ASPECT_FIT_PARENT:
                    if (isLandscape) {
                        width = mScreenWidth * mVideoWidth / mVideoHeight;
                        height = mScreenWidth;
                    } else {
                        width = mScreenWidth;
                ...
                case IRenderView.AR_16_9_FIT_PARENT:
                    width = mScreenWidth * 16 / 9;
                    height = mScreenWidth;
                    break;
                case IRenderView.AR_4_3_FIT_PARENT:
                    width = mScreenWidth * 4 / 3;
                    height = mScreenWidth;
                    break;
            }
...
//                    mRenderView.setVideoSize(mVideoWidth, mVideoHeight);
    ...
    private static final int[] s_allAspectRatio = {IRenderView.AR_ASPECT_FIT_PARENT, IRenderView.AR_ASPECT_FILL_PARENT,
    ...
    public IMediaPlayer createPlayer() {
        ...
        if (mUri != null) {
            ...
            ijkMediaPlayer.setWakeMode(getContext(), PowerManager.SCREEN_DIM_WAKE_LOCK);
        }
