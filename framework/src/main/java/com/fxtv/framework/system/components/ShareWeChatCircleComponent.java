...
public class ShareWeChatCircleComponent extends BaseShareComponent{
    ...
    public ShareWeChatCircleComponent(Context context, SystemShare.ICallBackSystemShare callBack){
     ...
     private BroadcastReceiver mWeChatReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()){
                case SHARE_OK:
                    if (mCallBack!=null){
                        Logger.d(TAG,"WechatCircle share onSuccess");
                        mCallBack.onSuccess();
                    }
                    break;
                case SHARE_CANCLE:
                    if (mCallBack!=null){
                        Logger.d(TAG,"WechatCircle share onCancle");
                        mCallBack.onCancle();
                    }
                    break;
                case SHARE_FARIL:
                    if (mCallBack!=null){
                        Logger.d(TAG,"WechatCircle share onFailure");
