...
public class CircularCornerImageView extends ImageView {
	...
	public CircularCornerImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CircularCornerImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	public static Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
		...
		c.drawBitmap(sbmp, null, rectF, paint);
